...
insert  into `tbl_menu`(`id_menu`,`menu`,`url`,`parent_menu`,`icon`) values (2,'Form','-',0,'icon-th-list '),(3,'Setting','-',0,'icon-cogs '),(4,'User Apps','setting/user',3,NULL),(5,'Role Menu','setting/role',3,NULL),(6,'Jabatan','data/jabatan',7,NULL),(7,'Data','-',0,'icon-folder-open '),(8,'Karyawan','data/karyawan',7,NULL),(25,'Master','-',0,'icon-book '),(9,'Report','#',0,'icon-list-alt'),(10,'Menu','setting/menu',3,NULL),(18,'Lembaga','data/lembaga',7,NULL);
...
insert  into `tbl_role_access`(`id_role`,`menu_id`,`lembaga_id`) values (167,9,1),(166,25,1),(165,7,1),(164,3,1),(163,2,1),(162,18,1),(161,8,1),(160,6,1),(159,10,1),(158,5,1),(157,4,1);
